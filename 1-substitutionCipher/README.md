...
#### Running ceasarCipherA.py
- On Windows, run:
```
python ceasarCipherA.py -h
```
- On Linux, run:
```
chmod u+x ceasarCipherA.py
ceasarCipherA.py
```
The output should look like this:
```
usage: ceasarCipherA.py [-h] (-e | -d) (-m MESSAGE | -f FILE) [-k KEY] [-o]
...
```
python ceasarCipherA.py -e -m "HELLO WORLD" -k 10
```
Output:
```
ROVVY GYBVN
...
```
python ceasarCipherA.py -e -m "HELLO WORLD" -k 10 -o
```
Output:
```
ROVVY GYBVN
...
```
python ceasarCipherA.py -e -f input.txt -k 10 
```
...
#### Running ceasarCipherB.py
- On Windows, run:
```
python ceasarCipherB.py -h
```
- On Linux, run:
```
chmod u+x ceasarCipherB.py
ceasarCipherB.py
```
The output should look like this:
```
usage: ceasarCipherB.py [-h] (-e | -d) (-m MESSAGE | -f FILE) [-k KEY] [-o]
...
For basic encryption, run:
```
python ceasarCipherB.py -e -m "HELLO WORLD" -k 10
```
Output:
```
ROVVY GYBVN
...
To save the output to a file:
```
python ceasarCipherB.py -e -m "HELLO WORLD" -k 10 -o
```
Output:
```
ROVVY GYBVN
...
To get the input from a file, use a `.txt` file and run this command:
```
python ceasarCipherB.py -e -f input.txt -k 10 
```
You can either print to the terminal or to a file.
